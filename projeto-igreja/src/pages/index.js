// pages/index.js DESENVOLVIDO POR GABRIEL BANDEIRA MACEDO DA COSTA 08/12/2024
      ...
      <section className={styles.atividades} id="atividades">
        ...
        <div className={styles.atividadesGrid}>
          ...
          <div className={styles.atividade}>
            ...
            <Image src="/images/estudo.png" alt="Estudos Bíblicos" width={200} height={200} />
          </div>
          <div className={styles.atividade}>
            <h3>Comunhão</h3>
